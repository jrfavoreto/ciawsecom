                ...
                <div class="row">
                    <div class="col-md-12">
						...
						<div class="pull-left" style="width:600px;">
						   <h2 align="pull-left">Pesquisa de Alunos RM2 2020</h2>
						   <br /><br />
						   <form id="framework_form" action="index2.php" method="post" >
							...
							<optgroup label="Turma">
							  <option value="21">SMV-01</option>
							  <option value="22">SMV-02</option>
							  <option value="23">SMV-03</option>
							  <option value="24">SMV-04</option>
							  <option value="25">SMV-05</option>
							  <option value="26">SMV-06</option>
							  <option value="27">SMV-07</option>
							  <option value="28">SMV-08</option>
							 </optgroup>
										...
										foreach ($_POST['framework2'] as $selectedOption){
											switch	($selectedOption){
												...
												case "data_de_apresentacao":
													echo ("<th>Data de Apresentação</th>");
													break;
												case "nacionalidade":
												...
												case "identidade_data_emissao":
													echo ("<th>Data de Emissão da Identidade</th>");
													break;
												...
												case "vinculo_marinha":
													echo ("<th>Vínculo Anterior com a Marinha</th>");
													break;
												case "quadro_forca_anterior":
													echo ("<th>Quadro e Força Anterior</th>");
													break;
												case "om_origem":
													echo "<th>OM de Origem</th>";
													break;
												case "servidor_publico":
													echo ("<th>Servidor Público</th>");
													break;
												case "residencia_medica":
													echo ("<th>Residência Médica</th>");
													break;
												case "endereco":
													echo ("<th>Endereço</th>");
													break;
												case "telefone_residencial":
													echo "<th>Tel. em caso de Emergência</th>";
													break;
